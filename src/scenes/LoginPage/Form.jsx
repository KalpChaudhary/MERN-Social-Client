...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    const savedUserResponse = await fetch(
      "https://mern-social-kalpchaudhary.herokuapp.com/auth/register",
      {
        method: "POST",
        body: formData,
      }
  ...
  const login = async (values, onSubmitProps) => {
    const loggedInResponse = await fetch("https://mern-social-kalpchaudhary.herokuapp.com/auth/login", {
      method: "POST",
